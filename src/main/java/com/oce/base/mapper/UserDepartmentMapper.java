...
public interface UserDepartmentMapper {
    ...
    boolean deleteByDepartmentid(@Param("id")Long id);

    //删除某部门下的某个人
    @Delete("delete from t_user_department where department_id=#{d_id} and user_id=@{u_id} ")
    boolean deleteByDepartmentidUserid(@Param("d_id")Long d_id,@Param("u_id") Long u_id);
